	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 String someText = getStringFromFile(textfile, numToCheck);
			 long beg = System.nanoTime();
			 for(int i = 0; i<trials; i++) {
				 BasicDocument a = new BasicDocument(someText);
				 a.getFleschScore();
			 }
			 long end = System.nanoTime();
			 double time = (end-beg)/1000000000;
			 System.out.print(time+"\t");
			 beg = System.nanoTime();
			 for(int i = 0; i<trials; i++) {
				 EfficientDocument b = new EfficientDocument(someText);
				 b.getFleschScore();
			 }
			 end = System.nanoTime();
			 time = (end-beg)/1000000000;
			 System.out.print(time+"\n");
		}
